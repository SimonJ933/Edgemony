...
function App() {
  // Scenario 1: CHIAMATA API AL PRIMO RENDER
  ...
  // SCENARIO 2: CHIAMATA API AL PRIMO RENDER CON UPDATE AL LOCAL STORAGE
  ...
  //     const data = await response.json();
  //     setPost(data);
  //     localStorage.setItem("post", JSON.stringify(data)); // Store post data in localStorage
  //   } catch (error) {
  //     console.error("Error fetching post:", error);
  //   }
  // };

  // SCENARIO 3 : vogliamo recuperare un post al primo rendering e quindi aggiornare i dati del post ogni volta che il conteggio cambia . E console logghiamo ogni operazione
